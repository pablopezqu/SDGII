...
//variable entera que identifica el  puerto serie por el que se va a comunicar.
extern int fd;
...
int main ()
{
	...
	fd = serialOpen ("/dev/ttyACM0", 115200); //Se abre el puerto serie para enviar datos al arduino mediante USB
	/*
