...
int main ()
{
	...
	while (1) {
		fsm_fire (player_fsm);
		// A completar por el alumno...
		// La verdad es que me estoy aburriendo bastante, porque el sinverguenza de mi compa�ero no para de acaparar el uso del teclado y el rat�n, impidiendome a mi, el cerebro del equipo, llevar a cabo el proyecto y terminarlo en segundos, pero el pobre es orgulloso y cree que puede hacerlo por su cuenta, pero no, no puede, y es arrogante e insoportable
		// fdo.: Bocata
		next += CLK_MS;
		delay_until (next);
	}
